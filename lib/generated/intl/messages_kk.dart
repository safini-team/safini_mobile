...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(count) => "${count} монета";

  static String m3(level) => "${level} деңгей кейіпкері";

  static String m4(minutes) => "${minutes} минут қалды";

  static String m5(minutes) => "${minutes} мин қалды";

  static String m6(used, limit) => "${used} қолданылды / ${limit} лимит";

  static String m7(count) => "Сізге тағы ${count} монета керек";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "coins": MessageLookupByLibrary.simpleMessage("Монеталар"),
    "coinsCount": m2,
