...
/// The `/auth` route: a direct jump into either side of the app. Not linked
/// from anywhere in the flow, kept for manual testing of the two shells.
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 18),
                      Text(s.tagline, style: AppText.lede),
                    ],
                  ),
                ),
                DsChoiceCard(
