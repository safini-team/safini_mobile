                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Enter a parent invite code shared by a family admin.',
                                  textAlign: TextAlign.center,
                                ...
                                TextFormField(
                                  ...
                                  validator: (value) {
                                    ...
                                    if (code.length < 4 || code.length > 16) {
                                      return 'Invalid invite code format. Must be 4-16 characters.';
                                    }
                                    return null;
                                  },
                                ...
                                ElevatedButton(
                                  ...
                                  child: state.isLoading
                                      ...
                                      : const Text('Join Family as Parent'),
                                ),
                                const SizedBox(height: 12),
                                OutlinedButton(
                                  onPressed: state.isLoading
                                      ...
                                      : () => context
                                            ...
                                            .joinFamily(_codeController.text),
