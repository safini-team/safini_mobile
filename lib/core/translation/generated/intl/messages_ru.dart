...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(childName) => "Создать задание для ${childName}";

  static String m6(level) => "Герой ${level} уровня";

  static String m7(count) =>
      "${Intl.plural(count, one: '${count} минута', few: '${count} минуты', many: '${count} минут', other: '${count} минуты')}";

  static String m8(minutes) => "Осталось ${minutes} мин.";

  static String m9(minutes) => "осталось ${minutes}м";

  static String m10(used, limit) => "${used} исп. / ${limit} лимит";

  static String m11(count) => "Вам нужно еще ${count} монет.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "createTaskProofTitle": MessageLookupByLibrary.simpleMessage(
      "Подтверждение",
    ),
    ...
    "createTaskRecurrenceOnce": MessageLookupByLibrary.simpleMessage(
      "Один раз",
    ),
    "createTaskRepeatsTitle": MessageLookupByLibrary.simpleMessage(
      "Повторение",
    ),
    "createTaskRewardLabel": MessageLookupByLibrary.simpleMessage(
      "Награда (Монеты времени)",
    ),
    "createTaskRewardsTitle": MessageLookupByLibrary.simpleMessage("Награды"),
    ...
    "createTaskStep2Title": MessageLookupByLibrary.simpleMessage(
      "Шаг 2 — Как ребёнок выполняет задание?",
    ),
    ...
    "createTaskTargetNumber": MessageLookupByLibrary.simpleMessage("Число"),
    "createTaskTargetTitle": MessageLookupByLibrary.simpleMessage("Цель"),
    ...
    "createTaskXpLabel": MessageLookupByLibrary.simpleMessage("ОП"),
