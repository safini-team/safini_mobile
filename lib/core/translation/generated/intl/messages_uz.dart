...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "${name} uchun qoʻshish";

  static String m1(name) => "${name} roʻyxatiga qoʻshish";

  static String m2(age, gender) => "${age} yosh • ${gender}";

  static String m3(age) => "Yosh: ${age}";

  static String m4(app, minutes) => "${app} · ${minutes} daqiqa";

  static String m5(minutes) => "${minutes} daqiqa";

  static String m6(coins) => "Tasdiqlash · ${coins} berish";

  static String m7(count) => "${Intl.plural(count, other: '${count} tanga')}";

  static String m8(count) => "${Intl.plural(count, other: '${count} vazifa')}";

  static String m9(time) => "Ilovalar ${time} gacha bloklangan.";

  static String m10(time) => "Yangilanish vaqti: ${time}";

  static String m11(name) => "${name} taraqqiyoti";

  static String m12(done, total, coins) =>
      "Bugun ${total} dan ${done} · ${coins} tanga kutmoqda";

  static String m13(name) => "${name} uchun kod tayyor";

  static String m14(count) =>
      "${Intl.plural(count, one: '${count} tanga', other: '${count} tanga')}";

  static String m15(count) => "${Intl.plural(count, other: '${count} tanga')}";

  static String m16(count) => "${Intl.plural(count, other: '${count} tanga')}";

  static String m17(count) =>
      "${Intl.plural(count, one: '${count} tanga mukofot', other: '${count} tanga mukofot')}";

  static String m18(name) => "${name} · kunlik limit";

  static String m19(time) => "Kunlik limit · ${time}";

  static String m20(name) => "${name}ni tahrirlash";

  static String m21(date, time) => "Amal qiladi: ${date}, ${time}";

  static String m22(name) => "Endi ${name}ning telefonini ulaymiz.";

  static String m23(done, total) => "${total} tadan ${done}";

  static String m24(name) => "${name} cheklansinmi?";

  static String m25(name) => "${name} bloklandi";
  ...
  static String m29(date) => "Oxirgi sinxronizatsiya: ${date}";

  static String m30(name) => "${name}ning telefonidagi barcha ilovalar";

  static String m31(name, time) => "${name} uchun bugun ${time} qoldi";

  static String m32(step, total) => "${total} tadan ${step}";

  static String m33(name, time) => "${name} bugun ${time} ishlatdi";

  static String m34(name) => "${name} ilovalari";

  static String m35(level) => "${level}-daraja qahramoni";

  static String m36(level) => "${level}-daraja";

  static String m37(name) => "${name} telefoni · bugun";

  static String m38(count) =>
      "${Intl.plural(count, one: '${count} daqiqa', other: '${count} daqiqa')}";

  static String m39(minutes) => "${minutes} daqiqa qoldi";

  static String m40(minutes) => "Bugun ${minutes} daqiqa qoldi";
  ...
  static String m43(app) => "Koʻpi ${app}da";

  static String m44(count) =>
      "${Intl.plural(count, other: '${count} kun ketma-ket')}";

  static String m45(total) => "${total} dan";

  static String m46(name) => "${name} telefoniga Safini oʻrnating";

  static String m47(percent) => "Keyingi darajagacha ${percent}%";

  static String m48(cost, time) => "${time} uchun ${cost} tanga";

  static String m49(coins) =>
      "${coins} band qilingan. Berganingizdan soʻng «Berildi» deb belgilang.";

  static String m50(name, prize) => "${name} soʻradi: ${prize}";
  ...
  static String m59(name) => "${name}ning hisobi oʻchirilsinmi?";

  static String m60(name) => "${name}ning hisobi butunlay oʻchirildi.";

  static String m61(name) => "${name} uchun saqlash";

  static String m62(name) => "${name} uchun saqlandi";

  static String m63(count) => "Barcha ${count} ta ilovani koʻrsatish";

  static String m64(code) => "Kod ${code} · ilova limitlari oʻchadi";

  static String m65(name) => "${name} chiqmoqchi";

  static String m66(count) =>
      "${Intl.plural(count, other: 'Kod notoʻgʻri. Yana ${count} ta urinish qoldi.')}";

  static String m67(count) => "${Intl.plural(count, other: '${count} vazifa')}";

  static String m68(tasks, coins) => "${tasks} · ${coins}";

  static String m69(scope, tasks) => "${scope} · ${tasks}";

  static String m70(tasks, coins) => "${tasks} qoldi - ${coins} yoʻlda";

  static String m71(time) => "${time} qoldi";

  static String m72(time) => "${time} ishlatildi";

  static String m73(count) => "yana ${count}";

  static String m74(name) =>
      "${name} telefonida \"Men bolaman\" boʻlimiga kiriting.";

  static String m75(used, limit) => "${used} ishlatildi / ${limit} cheklov";

  static String m76(used) => "${used} · cheklovsiz";

  static String m77(used, limit) => "${limit} dan ${used}";

  static String m78(used, limit) => "${limit} dan ${used} · oshdi";

  static String m79(time) => "Bugun ${time}";

  static String m80(seconds) => "${seconds} s qoldi";

  static String m81(count) =>
      "${Intl.plural(count, other: '${count} ta kutmoqda')}";

  static String m82(name) => "${name} telefoni kutilmoqda…";

  static String m83(name) =>
      "Narx belgilang va u ${name}ning doʻkoniga qoʻshiladi.";

  static String m84(name, prize) => "${name} orzusi: ${prize}";

  static String m85(name, coins) => "${name} · ${coins}";

  static String m86(age) => "${Intl.plural(age, other: '${age} yosh')}";

  static String m87(count) =>
      "${Intl.plural(count, other: 'Sizga yana ${count} tanga kerak.')}";

  static String m88(name) => "${name} (siz)";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addAPrize": MessageLookupByLibrary.simpleMessage("Sovgʻa qoʻshish"),
    ...
    "addToList": m1,
    "addToStore": MessageLookupByLibrary.simpleMessage("Doʻkonga qoʻshish"),
    ...
    "askParentToDeleteAccount": MessageLookupByLibrary.simpleMessage(
      "Hisobingni oʻchirmoqchi boʻlsang, ota-onangdan soʻra.",
    ),
    ...
    "budgetExplanation": MessageLookupByLibrary.simpleMessage(
      "Limit tugaganda Safini boshqaradigan ilovalar bloklanadi. Alohida ilova limitlari ham amal qiladi. Telefon, Xabarlar va Safini qoidalari yo‘q ilovalar ochiq qoladi.",
    ),
    "budgetMinutesError": MessageLookupByLibrary.simpleMessage(
      "0 dan 1440 gacha butun son kiriting.",
    ),
    "budgetMinutesHint": MessageLookupByLibrary.simpleMessage(
      "0 daqiqa Safini boshqaradigan ilovalarni bloklaydi.",
    ),
    "budgetNoFreeTime": MessageLookupByLibrary.simpleMessage("Bepul vaqt yo‘q"),
    "budgetOffExplanation": MessageLookupByLibrary.simpleMessage(
      "Faqat alohida ilova limitlari amal qiladi. Bugun ishlatilgan vaqt saqlanadi.",
    ),
    ...
    "budgetUnavailable": MessageLookupByLibrary.simpleMessage(
      "Umumiy limit ma’lumotlari mavjud emas. Yangilash uchun pastga torting.",
    ),
    "budgetUsageUnknown": MessageLookupByLibrary.simpleMessage(
      "Foydalanish bolaning qurilmasida ko‘rinadi.",
    ),
    ...
    "enforcementSignedOut": MessageLookupByLibrary.simpleMessage(
      "Bola telefonida Safini’dan chiqdi. Qayta kirmaguncha ilova limitlari ishlamaydi.",
    ),
    ...
    "finiNextTask": MessageLookupByLibrary.simpleMessage(
      "Birinchi vazifani qoʻshing. Vazifa uchun tanga beriladi.",
    ),
    "finiWhyAdmin": MessageLookupByLibrary.simpleMessage(
      "Shunda Safini oʻchmaydi. Oʻchirilsa, ota-onang biladi.",
    ),
    "finiWhyOverlay": MessageLookupByLibrary.simpleMessage(
      "Shunda vaqt tugaganda ilovani pauza qila olaman.",
    ),
    "finiWhyUsage": MessageLookupByLibrary.simpleMessage(
      "Shunda qaysi ilova ochiqligini koʻrib, vaqtni hisoblayman.",
    ),
    ...
    "iosScreenTimeNotSetUp": MessageLookupByLibrary.simpleMessage(
      "Bolaning iPhone’ida ekran vaqti sozlanmagan, shuning uchun ilova limitlari ishlamayapti. Unda Safini’ni oching va ekran vaqtiga ruxsat bering.",
    ),
    ...
    "kidHelloSpend": MessageLookupByLibrary.simpleMessage(
      "Tangalarni ekran vaqti va sovgʻalarga sarfla",
    ),
    "kidHelloTasks": MessageLookupByLibrary.simpleMessage(
      "Vazifalarni bajar, tanga ol",
    ),
    ...
    "kidSetupBatteryLink": MessageLookupByLibrary.simpleMessage(
      "Safini oʻzi yopilyaptimi?",
    ),
    "kidSetupGo": MessageLookupByLibrary.simpleMessage("Sozlamalarni ochish"),
    "kidSetupHintAdmin": MessageLookupByLibrary.simpleMessage(
      "Pastga suring va «Faollashtirish» ni bosing.",
    ),
    ...
    "markGiven": MessageLookupByLibrary.simpleMessage("Berildi"),
    ...
    "noOverallDailyBudget": MessageLookupByLibrary.simpleMessage("O‘chirilgan"),
    "noPrizesYet": MessageLookupByLibrary.simpleMessage(
      "Hozircha sovgʻalar yoʻq. Orzu qil - ota-onang uni qoʻshishi mumkin.",
    ),
    ...
    "prizeAskReviewBody": m49,
    "prizeAskReviewTitle": m50,
    ...
    "prizeIdeaCinema": MessageLookupByLibrary.simpleMessage("Kinoga borish"),
    "prizeIdeaIceCream": MessageLookupByLibrary.simpleMessage("Muzqaymoq"),
    "prizeIdeaLego": MessageLookupByLibrary.simpleMessage("Lego toʻplami"),
    "prizeIdeaNewToy": MessageLookupByLibrary.simpleMessage("Yangi oʻyinchoq"),
    "prizeIdeaPet": MessageLookupByLibrary.simpleMessage("Uy hayvoni"),
    "prizeIdeaPizzaNight": MessageLookupByLibrary.simpleMessage(
      "Pitsa kechasi",
    ),
    "prizeIdeaVideoGame": MessageLookupByLibrary.simpleMessage(
      "Yangi video oʻyin",
    ),
    "prizeIdeasTitle": MessageLookupByLibrary.simpleMessage("Gʻoyalar"),
    "prizeLabel": MessageLookupByLibrary.simpleMessage("Sovgʻa"),
    "prizeNameHint": MessageLookupByLibrary.simpleMessage("Muzqaymoq"),
    "prizeNameLabel": MessageLookupByLibrary.simpleMessage("Nomi"),
    "prizeNoteHint": MessageLookupByLibrary.simpleMessage(
      "Faqat dam olish kunlari",
    ),
    "prizeNoteLabel": MessageLookupByLibrary.simpleMessage("Izoh"),
    "prizePriceLabel": MessageLookupByLibrary.simpleMessage("Narx"),
    "prizeWaiting": MessageLookupByLibrary.simpleMessage("Kutilmoqda"),
    "prizeWaitingBody": MessageLookupByLibrary.simpleMessage(
      "Ota-onang koʻradi. Javob berguncha tangalaring band turadi.",
    ),
    "prizeWaitingForYou": m52,
    "prizesBody": m53,
    ...
    "removeChildConfirmBody": m58,
    "removeChildConfirmTitle": m59,
    "removeChildDeletedSuccess": m60,
    ...
    "removeChildForbidden": MessageLookupByLibrary.simpleMessage(
      "Bu hisobni oʻchirishga ruxsatingiz yoʻq.",
    ),
    "removeChildInProgress": MessageLookupByLibrary.simpleMessage(
      "Bola hisobi oʻchirilmoqda…",
    ),
    ...
    "removeChildNotFound": MessageLookupByLibrary.simpleMessage(
      "Bu bola endi oilangizda yoʻq. Oila roʻyxati yangilandi.",
    ),
    "removeChildRefreshError": MessageLookupByLibrary.simpleMessage(
      "Bola hisobi oʻchirildi, lekin oila roʻyxatini yangilab boʻlmadi. Uni qayta yangilang.",
    ),
    "removeChildUnauthorized": MessageLookupByLibrary.simpleMessage(
      "Sessiya muddati tugadi. Bola hisobini oʻchirish uchun qayta kiring.",
    ),
    ...
    "removePrize": MessageLookupByLibrary.simpleMessage("Sovgʻani oʻchirish"),
    ...
    "setupStepLimit": MessageLookupByLibrary.simpleMessage(
      "Kunlik cheklov belgilash",
    ),
    "setupStepPhone": MessageLookupByLibrary.simpleMessage("Telefonini ulash"),
    "setupStepPrize": MessageLookupByLibrary.simpleMessage("Sovgʻa qoʻshish"),
    "setupStepTask": MessageLookupByLibrary.simpleMessage("Vazifa yaratish"),
    "setupYourFamily": MessageLookupByLibrary.simpleMessage(
      "Oilangizni sozlang",
    ),
    "showAllAppsCount": m63,
    ...
    "signoutAllow": MessageLookupByLibrary.simpleMessage("Ruxsat berish"),
    "signoutAskAgain": MessageLookupByLibrary.simpleMessage("Yana soʻrash"),
    "signoutAskBody": MessageLookupByLibrary.simpleMessage(
      "Chiqsang, ilova limitlari oʻchadi, shuning uchun ota-onang rozi boʻlishi kerak. Ularga soʻrov yubordik.",
    ),
    "signoutAskTitle": MessageLookupByLibrary.simpleMessage(
      "Chiqish uchun ota-onangdan soʻra",
    ),
    "signoutDenied": MessageLookupByLibrary.simpleMessage(
      "Ota-onang ruxsat bermadi, shuning uchun hisobingda qolasan.",
    ),
    "signoutEnded": MessageLookupByLibrary.simpleMessage(
      "Bu soʻrov tugadi. Hali ham chiqish kerak boʻlsa, yana soʻra.",
    ),
    "signoutKeep": MessageLookupByLibrary.simpleMessage("Chiqarmaslik"),
    "signoutReviewMeta": m64,
    "signoutReviewTitle": m65,
    ...
    "wishForSomething": MessageLookupByLibrary.simpleMessage("Orzu qilish"),
    ...
    "wishSheetBody": MessageLookupByLibrary.simpleMessage(
      "Narxini ayt. Ota-onang uni doʻkoningga qoʻshishi mumkin.",
    ),
    "wishSheetTitle": MessageLookupByLibrary.simpleMessage(
      "Nimani orzu qilasan?",
    ),
    "wornLabel": MessageLookupByLibrary.simpleMessage("Kiyilgan"),
    "worthCoins": m85,
    "yearsOld": m86,
    "youNeedMoreCoins": m87,
    "youSuffix": m88,
    ...
    "yourOwnPrize": MessageLookupByLibrary.simpleMessage("Oʻz sovgʻangiz"),
