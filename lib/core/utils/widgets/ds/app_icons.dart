...
class AppIcons {
  ...
  // ── brand marks ── full colour, so no currentColor and no filter.

  /// Google's four-colour "G", as their sign-in branding requires it: never
  /// recoloured, always on a white or neutral button.
  static Widget google({double size = 20}) => SvgPicture.string(
